...
# These are our data
df = pd.read_csv('./data/dash_ts_updated.csv')
...
# We need to get the link between trial number and rhyme name
...
def update_graph(speaker, rhyme_name, point_hand, speech_rate, kin_feat, ac_feat):
    ...
    ## VIDEODATA
    # Give me the value of source in dff
    source = dff.source.values[0]
    print(source)
